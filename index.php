...
<head>
    ...
    <title>USER AUTHENTICATION SYSTEM USING QUESTION AND ANSWER!</title>
                ...
                <div class="container">
                    <div class="navbar-header pull-left">
                        <a class="navbar-brand page-scroll" href="#page-top">
                            ...
                            <span class="brand-logo">USER AUTHENTICATION SYSTEM USING QUESTION AND ANSWER</span>
                        </a>
                    </div>
            ...
            <header id="intro-carousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <div class="carousel-caption">
                            <h1 class="wow animated slideInDown" style="font-size: 30px;">Welcome To USER AUTHENTICATION SYSTEM USING QUESTION AND ANSWER! </h1>
                ...
                <div class="mouse"></div>
                            ...
                            <div class="col-md-12 text-center" style="background-color: #000;color: #fff;padding: 10px;font-weight: bolder;">
                                &copy; 2021.USER AUTHENTICATION SYSTEM USING QUESTION AND ANSWER! All rights reserved.
                            </div><!-- /.col-md-12 -->
